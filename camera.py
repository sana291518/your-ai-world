...
class VideoCamera(object):
    def __init__(self):
        ...
        self.model = model_from_json(open("emotion_detector/facial_expression_model_structure.json", "r").read())
        self.model.load_weights('emotion_detector/facial_expression_model_weights.h5')
